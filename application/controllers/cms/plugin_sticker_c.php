 ...
 * 
 */
class Plugin_sticker_c extends PL_Controller {
	...
	function __construct(){
		...
		$this->plugin_display_array[4]				= "Imagen m&aacute;scara";
		$this->plugin_display_array[5]				= "Imagen m&aacute;scra mediana";
		$this->plugin_display_array[6]				= "Imagen m&aacute;scra peque&ntilde;a";
	...
	public function _html_plugin_create(){
		...
		$data_array['form_html']			.= "<div class='control-group'>".form_label($this->plugin_display_array[4],'',array('class' => 'control-label'))."<div class='controls'>".form_upload(array('name' => 'STICKER_IMAGE[]', 'class' => 'span6'))."<span class='help-block'>350 x 247px</span></div></div>";
	...
	public function _html_plugin_update($result_data){
		...
		$data_array['form_html']			.= "<div class='control-group'>".form_label($this->plugin_display_array[2],'',array('class' => 'control-label'))."<div class='controls'><div class='input-prepend'><span class='add-on'>Q.</span>".form_input(array('name' => 'STICKER_PRICE', 'value' => $result_data->STICKER_PRICE, 'class' => 'span2'))."</div></div></div>";
