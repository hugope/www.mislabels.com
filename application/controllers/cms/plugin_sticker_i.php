 ...
 * 
 */
class Plugin_sticker_i extends PL_Controller {
	...
	function __construct(){
		...
		$this->plugin_display_array[4]				= "Imagen m&aacute;scara grande";
		$this->plugin_display_array[5]				= "Imagen m&aacute;scara mediana";
		$this->plugin_display_array[6]				= "Imagen m&aacute;scara peque&ntilde;a";
		$this->plugin_display_array[7]				= "Precio";
		$this->plugin_display_array[8]				= "Galer&iacute;a";
		$this->plugin_display_array[9]				= "Descripci&oacute;n";
		$this->plugin_display_array[10]				= "&#191;Agregar a populares?";
	...
	public function _html_plugin_create(){
		...
		$data_array['form_html']			.= "<div class='control-group'>".form_label($this->plugin_display_array[7],'',array('class' => 'control-label'))."<div class='controls'><div class='input-prepend'><span class='add-on'>Q.</span>".form_input(array('name' => 'STICKER_PRICE', 'class' => 'span2'))."</div></div></div>";
		...
		$data_array['form_html']			.= "<div class='control-group'>".form_label($this->plugin_display_array[9],'',array('class' => 'control-label'))."<div class='controls'>".form_textarea(array('name' => 'STICKER_DESCRIPTION', 'class' =>'span6'))."</div></div>";
		$data_array['form_html']			.= "<div class='control-group'>".form_label($this->plugin_display_array[10],'',array('class' => 'control-label'))."<div class='controls'><label class='checkbox'>".form_checkbox('STICKER_POPULAR', 'SI')."Seleccionar para que aparezca esta etiqueta en la pagina de inicio.</label></div></div>";
	...
	public function _html_plugin_update($result_data){
		...
		$data_array['form_html']			.= "<div class='control-group'>".form_label($this->plugin_display_array[7],'',array('class' => 'control-label'))."<div class='controls'><div class='input-prepend'><span class='add-on'>Q.</span>".form_input(array('name' => 'STICKER_PRICE', 'value' => $result_data->STICKER_PRICE, 'class' => 'span2'))."</div></div></div>";
		...
		$data_array['form_html']			.= "<div class='control-group'>".form_label($this->plugin_display_array[5],'',array('class' => 'control-label'))."<div class='controls'>".form_upload(array('name' => 'STICKER_IMAGE[]', 'class' => 'span6'))."</div></div>";
		$data_array['form_html']			.= "<div class='control-group'>".form_label($this->plugin_display_array[6],'',array('class' => 'control-label'))."<div class='controls'>".form_upload(array('name' => 'STICKER_IMAGE[]', 'class' => 'span6'))."</div></div>";
		$data_array['form_html']			.= "<div class='control-group'>".form_label($this->plugin_display_array[9],'',array('class' => 'control-label'))."<div class='controls'>".form_textarea(array('name' => 'STICKER_DESCRIPTION', 'value' => $result_data->STICKER_DESCRIPTION, 'class' =>'span6'))."</div></div>";
		$data_array['form_html']			.= "<div class='control-group'>".form_label($this->plugin_display_array[10],'',array('class' => 'control-label'))."<div class='controls'><label class='checkbox'>".form_checkbox('STICKER_POPULAR', 'SI', $selected)."Seleccionar para que aparezca esta etiqueta en la pagina de inicio.</label></div></div>";
